...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="51">
    ...
    <div class="container-fluid bg-light my-6 mt-0" id="home">
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="{{ asset('site/img/profile.png') }}" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="row g-3 mb-4">
                        <div class="col-sm-6">
                            <img class="img-fluid rounded" src="{{ asset('site/img/about-1.jpg') }}" alt="">
                        </div>
                        <div class="col-sm-6">
                            <img class="img-fluid rounded" src="{{ asset('site/img/about-2.jpg') }}" alt="">
                        </div>
                    </div>
                    ...
                    <div class="portfolio-img rounded overflow-hidden">
                        ...
                        <div class="portfolio-btn">
                            <div class="container">
                                ...
                                <div class="row">
                                    <a class="btn btn-lg-square btn-outline-secondary border-2" href="{{ asset('storage/'. $project->image) }}" data-lightbox="portfolio"><i class="fa fa-eye"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item position-relative">
                        <img class="img-fluid rounded" src="{{ asset('site/img/team-1.jpg') }}" alt="">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item position-relative">
                        <img class="img-fluid rounded" src="{{ asset('site/img/team-2.jpg') }}" alt="">
                        <div class="team-text bg-white rounded-end p-4">
                            <div>
                                <h5>Full Name</h5>
                                <span>Designer</span>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item position-relative">
                        <img class="img-fluid rounded" src="{{ asset('site/img/team-3.jpg') }}" alt="">
                        <div class="team-text bg-white rounded-end p-4">
                            <div>
                                <h5>Full Name</h5>
                                <span>Designer</span>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-3 d-none d-lg-block">
                    <div class="testimonial-left h-100">
                        <img class="img-fluid wow fadeIn" data-wow-delay="0.1s" src="{{ asset('site/img/testimonial-1.jpg') }}" alt="">
                        <img class="img-fluid wow fadeIn" data-wow-delay="0.3s" src="{{ asset('site/img/testimonial-2.jpg') }}" alt="">
                        <img class="img-fluid wow fadeIn" data-wow-delay="0.5s" src="{{ asset('site/img/testimonial-3.jpg') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="owl-carousel testimonial-carousel">
                        <div class="testimonial-item text-center">
                            <div class="position-relative mb-5">
                                <img class="img-fluid rounded-circle border border-secondary p-2 mx-auto" src="{{ asset('site/img/testimonial-1.jpg') }}" alt="">
                        ...
                        <div class="testimonial-item text-center">
                            <div class="position-relative mb-5">
                                <img class="img-fluid rounded-circle border border-secondary p-2 mx-auto" src="{{ asset('site/img/testimonial-2.jpg') }}" alt="">
                                <div class="testimonial-icon">
                                    <i class="fa fa-quote-left text-primary"></i>
                                </div>
                            </div>
                        ...
                        <div class="testimonial-item text-center">
                            <div class="position-relative mb-5">
                                <img class="img-fluid rounded-circle border border-secondary p-2 mx-auto" src="{{ asset('site/img/testimonial-3.jpg') }}" alt="">
                                <div class="testimonial-icon">
                                    <i class="fa fa-quote-left text-primary"></i>
                                </div>
                            </div>
    ...
    <script src="{{ asset('site/lib/typed/typed.min.js') }}"></script>
